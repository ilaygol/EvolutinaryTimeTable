$(function(){
    $("#reqGenerationCHK").change(function(){
        if(this.checked)
        {
            document.getElementById("reqGenerationTXT").disabled=false;
        }
        else
        {
            document.getElementById("reqGenerationTXT").value='';
            document.getElementById("reqGenerationTXT").disabled=true;
        }
    })
})
$(function(){
    $("#reqFitnessCHK").change(function(){
        if(this.checked)
        {
            document.getElementById("reqFitnessTXT").disabled=false;
        }
        else
        {
            document.getElementById("reqFitnessTXT").value='';
            document.getElementById("reqFitnessTXT").disabled=true;
        }
    })
})
$(function(){
    $("#reqTimeCHK").change(function(){
        if(this.checked)
        {
            document.getElementById("reqTimeTXT").disabled=false;
        }
        else
        {
            document.getElementById("reqTimeTXT").value='';
            document.getElementById("reqTimeTXT").disabled=true;
        }
    })
})
